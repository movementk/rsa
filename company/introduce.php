        ...
        <div class="container">
            <div class="introduce">
                <article class="company-intro">
                    ...
                    <div class="article-content">
                        ...
                        <div class="intro-list">
                            <p class="figure">
                                <img src="/assets/images/company/company_intro_img.png" alt="">
                            </p>
                            <ol class="sr-only">
                                <li>본사 및 4개 영업지사 (평택, 서울, 부산, 대구, 광주)</li>
                                <li>자동화 연구소 및 제조센터</li>
                                <li>전국 40여 개사의 대리점 및 특판 파트너</li>
                                <li>국내외 4~500여개사의 고객사</li>
                                <li>글로벌 제조 . 엔지니어링 서비스</li>
                            </ol>
                        </div>
                    </div>
                </article>
                <article class="service-area">
                    ...
                    <div class="article-content">
                        <p>
                            알에스오토메이션은 금번 신규회사 출범으로 개발/제조/영업/서비스 등의 전 분야에서 보다 <b>경쟁력 있는 품질과<br>
                            가격의 제품 공급, 실제적인 서비스</b>로 고객 여러분의 <b>제조 경쟁력 향상에 기여하는 회사</b>가 될 것입니다.
                        </p>
